...
- winetricks
  ...
  1. 安裝 winetricks `cd ~/` `wget  https://raw.githubusercontent.com/Winetricks/winetricks/master/src/winetricks` `chmod +x winetricks` `sudo cp winetricks /usr/local/bin/winetricks`
